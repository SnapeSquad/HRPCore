...
public class VaultEconomyProvider implements Economy {
    ...
    public VaultEconomyProvider(EconomyService economyService) {
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer player, double amount) {
        ...
        double balance = economyService.getBalance(uuid).doubleValue();
    ...
    public EconomyResponse depositPlayer(OfflinePlayer player, double amount) {
        ...
        UUID uuid = player.getUniqueId();
        BigDecimal bigAmount = BigDecimal.valueOf(amount);
        economyService.deposit(uuid, bigAmount);
        double balance = economyService.getBalance(uuid).doubleValue();
    ...
    public boolean createPlayerAccount(String playerName) {
        return true; // Accounts are created on demand
    }
